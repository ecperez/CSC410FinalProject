...
local blueTower = {tag="tower", HP=4, xPos=display.contentWidth/2, yPos=0,tPos=0};



function blueTower:new (o)    --constructor
  o = o or {}; 
  setmetatable(o, self);
  self.__index = self;
  return o;
